  ...
  return (
    ...
    <div className='flex items-center justify-center grid grid-rows-2 grid-flow-col gap-6 mt-28'>
      ...
      <div className='flex items-center justify-center mx-auto'>
        <button type='submit' class="bg-teal-600 hover:bg-teal-800 transition duration-300 text-white text-lg p-2 w-1/2 mt-8 rounded-3xl font-bold uppercase w-80">Kupuję i płacę</button>
      </div>
    </>
  )
}
